  ...
  return (
    ...
    <div className='brand-card'>
      <div className='card p-3 mt-2 brand-info v-center fs-smaller text-secondary'>
        <p className='mt-3'> &nbsp; 
          <FaCircleInfo className='v-center' size={16} fill='#FFDB58'/>
        ...
        <p> &nbsp; <FaPhone size={16} fill='forestgreen'/> &nbsp; {sellerInfo?.phone}</p>
        <p> &nbsp; <MdEmail size={18} fill='#F4BB44'/> &nbsp; {sellerInfo?.email}</p>
