          ...
          <div className="card p-1 mt-1" id="picture-credits">
            <div className="card-body mx-auto">
              ...
              <div className="mx-auto">
                <p>The captivating visuals within this application have been made possible by the talented photographers and artists who share their work with the world. </p>
                ...
                <ul>
                  <li>
                    ...
                    is a generous community of photographers providing high-quality, royalty-free images that breathe life into this project.
                  </li>
                  <li>
