      ...
      <div className='container p-2'>
        ...
        <div className='card-body text-center'>
          ...
          <div className='p-1 m-5'>
            ...
            <p>
              Your submission of personal information through the store is governed by our Privacy Policy. To view our Privacy Policy, click <a className='link' href='/privacy-policy'>here</a>.
            </p>
          </div>
          ...
          <div className='p-1 m-5'>
            ...
            <p>
              You agree to indemnify, defend and hold harmless Afrofashion and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, 
